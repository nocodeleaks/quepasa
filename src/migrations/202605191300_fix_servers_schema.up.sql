CREATE TABLE IF NOT EXISTS `servers_202605191300` (
...
INSERT INTO `servers_202605191300` (
  `token`, `wid`, `verified`, `devel`,
  `groups`, `broadcasts`, `readreceipts`, `calls`, `readupdate`,
  `user`, `timestamp`
)
SELECT
  `token`, `wid`, `verified`, `devel`,
...
DROP TABLE `servers`;
ALTER TABLE `servers_202605191300` RENAME TO `servers`;
